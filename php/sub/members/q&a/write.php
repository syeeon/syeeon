...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../../css/sub/members/q&a/write.css">
                ...
                <form name="formCheck" action="" method="post" onsubmit="return formCheck()">
                    <fieldset>
                        ...
                        <div class="input_box">
                            ...
                            <input type="password" id="u_pwd" name="u_pwd" class="txt_box">
                            <br><span id="err_pwd"  class="err_txt"></span>
                        </div>
                        <div class="input_box">
                            <label for="u_title" class="c_title">제목</label>
                            <input type="text" id="u_title" name="u_title" class="txt_box" placeholder="문의사항입니다.">
                            <br><span id="err_title"  class="err_txt"></span>
                        </div>
                        <div class="input_box">
                            <label for="u_content" class="c_title text_title">내용</label>
                            <textarea id="u_content" name="u_content" placeholder="내용을 입력해주세요."></textarea>
